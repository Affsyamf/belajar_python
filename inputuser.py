...
# print("Data yang diinput user : ", data, type(data))

# dataint = int(input("masukan angka : "))
# datafloat = float(input("Angka desimal : "))
# print("Angka - ", dataint, type(dataint))
# print ("Angka Desimal : ", datafloat, type(datafloat))

databoolangka = input("Masukan angka : ")
